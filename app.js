...
mongoose.connect("mongodb+srv://doadmin:G4m6S2Jjv985i30X@db-mongodb-sgp1-05239-0193f6f9.mongo.ondigitalocean.com/affburg?tls=true&authSource=admin&replicaSet=db-mongodb-sgp1-05239", {
...
// Archive
const reportArchive = require("./routes/archive/reportArchive");
app.use("/archived", reportArchive);
